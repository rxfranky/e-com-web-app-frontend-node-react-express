...
import { quantityControl } from "../utils/http-requests";
    ...
    return (
        <>
            <div id="cartItem">
                        ...
                        <div id='quan&Price' className='flex gap-30 items-center'>
                            <div className='border border-gray-400 flex gap-1.5 p-0.75'>
                                <span onClick={() => { handleQuantity(quantity === 1 ? 'delete' : 'dec') }} className="cursor-pointer">
                                    <svg viewBox="0 0 24 24" fill="currentColor" width="24" height="24" className="sZxd73l"><path fillRule="evenodd" d="M20,12 L20,13 L5,13 L5,12 L20,12 Z"></path></svg>
                                </span>
                                <span>{quantity}</span>
                                <span onClick={() => { handleQuantity('inc') }} className="cursor-pointer">
                                    <svg viewBox="0 0 24 24" fill="currentColor" width="24" height="24" className="sZxd73l"><path fillRule="evenodd" d="M13,5 L13,12 L20,12 L20,13 L13,13 L13,20 L12,20 L11.999,13 L5,13 L5,12 L12,12 L12,5 L13,5 Z"></path></svg>
                                </span>
                            </div>
                ...
                <div id="partition" className="w-[345.5px] h-[0.5px] bg-gray-300 mt-4">
                </div>
            </div>
        </>
    )
